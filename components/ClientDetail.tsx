...
import { ArrowLeft, MessageSquare, Settings, Users, Play, Send, Bot, Smartphone, Copy, Check, X, Calendar, Phone, Activity, Mic, Volume2, Edit, Trash2, Save, ExternalLink } from 'lucide-react';
        ...
        <div className="flex-1 bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden flex flex-col">
            ...
            {activeTab === 'leads' && (
                <div className="p-6 h-full overflow-y-auto">
                    <h3 className="font-bold text-slate-900 mb-4">Captured Leads ({localLeads.length})</h3>
                    {localLeads.length === 0 ? (
                                           ...
                                           {['Alloy', 'Echo', 'Shimmer'].map((voice) => (
                                               <button
                                                   ...
                                                   className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm border ${
                                                       config.voiceId === voice.toLowerCase() 
